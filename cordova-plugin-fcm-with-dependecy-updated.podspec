...
DESC
  ...
  spec.homepage     = "https://github.com/geekedge/cordova-plugin-fcm-with-dependecy-updated"
  ...
  spec.source       = { :git => "https://github.com/geekedge/cordova-plugin-fcm-with-dependecy-updated.git", :tag => "v#{spec.version}" }
